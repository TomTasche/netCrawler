...
public class CopyOfSimpleTelnetConnection implements CommandLine {
...
//	private JSimpleTerminal debugTerminal;
	...
	public CopyOfSimpleTelnetConnection(SimpleNetworkDevice device, int sourcePort, Inet4Address destinationAddress, int destinationPort) throws IOException {
		this.device = device;
