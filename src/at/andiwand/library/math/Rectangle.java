...
public class Rectangle {
	 ...
	 * 
	 * @param size the diagonal size of the rectangle.
	 */
	 ...
	 * 
	 * @param rectangle the <code>Rectangle</code> object to copy.
	 */
	 ...
	 * the rectangle <code>true</code> is returned, otherwise
	 * <code>false</code>.
	 * 
	 * @param point the point as an position vector to intersect.
	 ...
	 * 
	 * @param rectangle the rectangle to intersect.
