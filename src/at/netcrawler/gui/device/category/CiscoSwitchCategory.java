...
public class CiscoSwitchCategory extends Category {
	...
	public Component render(NetworkModel device) {
		...
		builder.addTextRow("Model Number", device.getValue(CiscoSwitchExtension.MODEL_NUMBER));
		builder.addTextRow("System Serial Number", device.getValue(CiscoSwitchExtension.SYSTEM_SERIAL_NUMBER));
