...
public class CiscoSwitchCategory extends Category {
	...
	public Component render(DeviceManager manager, NetworkDevice device) {
		...
		builder.addTextRow("Model Number", manager, device,
				CiscoSwitchExtension.MODEL_NUMBER);
		builder.addTextRow("System Serial Number", manager, device,
				CiscoSwitchExtension.SYSTEM_SERIAL_NUMBER);
