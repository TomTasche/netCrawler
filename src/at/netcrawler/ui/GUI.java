...
public class GUI extends JFrame {
	...
	JButton refresh = new JButton(new ImageIcon("res/refresh.png"));
	JButton stop = new JButton(new ImageIcon("res/stop.png"));
	JButton plus = new JButton(new ImageIcon("res/plus.png"));
	...
	JTextField info = new JTextField("Suche läuft...");
	...
	WindowAdapter adapter = new WindowAdapter() {
		...
		public void windowClosing(WindowEvent e) {
			...
			if (JOptionPane.showOptionDialog(null, "Wollen Sie das Programm wirklich beenden?", "",
