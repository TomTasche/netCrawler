...
public class D_SSH1Client extends D_SSHClient {
	...
	public D_SSH1Client(InetAddress address, String username, String password) throws IOException {
		super(address, username, password);
	}
	public D_SSH1Client(String host, String username, String password) throws IOException {
		super(host, username, password);
	}
	public D_SSH1Client(InetSocketAddress socketAddress, String username, String password) throws IOException {
		super(socketAddress, username, password);
	}
	public D_SSH1Client(String host, int port, String username, String password) throws IOException {
		super(host, port, username, password);
	}
	public D_SSH1Client(InetAddress address, int port, String username, String password) throws IOException {
	...
	public void connect(InetAddress address, int port, String username,
		...
		if (!client.shell())
			throw new IOException("Was not able to connect!");
	}
