...
public class NetworkDevice extends NetworkModel {
	...
	public static final TypeToken<?> CONNECTED_VIA_TYPE = new TypeToken<Class<? extends Connection>>() {};
	
	public static final String AVAILABLE_CONNECTIONS = "device.availableConnections";
	public static final TypeToken<?> AVAILABLE_CONNECTIONS_TYPE = new TypeToken<Set<ConnectionType>>() {};
	
	public static final String CONNECTION_SETTINGS = "device.connectionSettings";
	public static final TypeToken<?> CONNECTION_SETTINGS_TYPE = new TypeToken<Map<ConnectionType, ConnectionSettings>>() {};
