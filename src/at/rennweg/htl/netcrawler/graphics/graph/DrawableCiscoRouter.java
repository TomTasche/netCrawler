...
public class DrawableCiscoRouter extends DrawableNetworkDevice {
	
	public static final String IMAGE_NAME = "router.png";
	...
	public DrawableCiscoRouter(Object coveredVertex) {
		super(coveredVertex);
