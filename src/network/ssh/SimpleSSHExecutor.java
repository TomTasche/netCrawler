...
public class SimpleSSHExecutor {
	...
	public SimpleSSHExecutor(String login, String password) {
		this(login.split("@")[1], DEFAULT_PORT, login.split("@")[0], password);
	}
	public SimpleSSHExecutor(String host, String user, String password) {
		this(host, DEFAULT_PORT, user, password);
	}
	public SimpleSSHExecutor(String host, int port, String username, String password) {
		this.host = host;
		this.port = port;
